...
class Settings(BaseSettings):
    ...
    # LLM provider switch: "openai" (default), "openrouter", or "0g"
    # (0G Compute Router — OpenAI-compatible, TEE-verified decentralized
    # inference). All providers use ChatOpenAI with a different base_url/api_key.
