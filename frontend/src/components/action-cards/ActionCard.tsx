          ...
          {state === "done" ? (
            ...
            <motion.div whileHover={{ scale: isPending ? 1 : 1.02 }} whileTap={{ scale: isPending ? 1 : 0.98 }}>
              <Button
                ...
                radius="full"
                size="md"
                className="max-w-full shrink-0 rounded-full border border-[var(--accent)] bg-[var(--accent)] px-5 py-2 text-xs font-semibold text-[var(--accent-ink)] shadow-[0_0_15px_rgba(255,180,84,0.2)] transition-all hover:bg-[var(--accent)]/90 hover:shadow-[0_0_25px_rgba(255,180,84,0.35)] disabled:cursor-wait disabled:opacity-60 sm:max-w-[55%]"
              >
